...
SEED_RATE_CARDS: Final[tuple[RateCard, ...]] = (
    # ---- OpenAI ----
    _card(Provider.OPENAI, "gpt-5", ModelType.REASONING, inp="1.25", out="10.00",
          cached_in="0.125", reasoning="10.00", context_window=400_000,
          max_output_tokens=128_000, latency=1400, quality="0.97",
          prompt_cache=True, batch=True, vision=True),
    _card(Provider.OPENAI, "gpt-5-mini", ModelType.REASONING, inp="0.25", out="2.00",
          cached_in="0.025", reasoning="2.00", context_window=400_000,
          max_output_tokens=128_000, latency=800, quality="0.90",
          prompt_cache=True, batch=True, vision=True),
    _card(Provider.OPENAI, "gpt-4.1", ModelType.MULTIMODAL, inp="2.00", out="8.00",
          cached_in="0.50", context_window=1_047_576, max_output_tokens=32_768,
          latency=900, quality="0.92", prompt_cache=True, batch=True, vision=True),
    _card(Provider.OPENAI, "gpt-4.1-mini", ModelType.MULTIMODAL, inp="0.40", out="1.60",
          cached_in="0.10", context_window=1_047_576, max_output_tokens=32_768,
          latency=550, quality="0.86", prompt_cache=True, batch=True, vision=True),
    _card(Provider.OPENAI, "gpt-4.1-nano", ModelType.CHAT, inp="0.10", out="0.40",
          cached_in="0.025", context_window=1_047_576, max_output_tokens=32_768,
          latency=350, quality="0.78", prompt_cache=True, batch=True, vision=True),
    _card(Provider.OPENAI, "text-embedding-3-small", ModelType.EMBEDDING,
          embedding="0.02", context_window=8_191, max_output_tokens=0,
          latency=120, quality="0.80", batch=True, tools=False),
    _card(Provider.OPENAI, "text-embedding-3-large", ModelType.EMBEDDING,
          embedding="0.13", context_window=8_191, max_output_tokens=0,
          latency=180, quality="0.88", batch=True, tools=False),
    # ---- Anthropic ----
    _card(Provider.ANTHROPIC, "claude-fable-5", ModelType.REASONING, inp="5.00", out="25.00",
          cached_in="0.50", cache_write="6.25", reasoning="25.00",
          context_window=500_000, max_output_tokens=64_000, latency=1300,
          quality="0.98", prompt_cache=True, batch=True, vision=True),
    _card(Provider.ANTHROPIC, "claude-opus-5", ModelType.REASONING, inp="5.00", out="25.00",
          cached_in="0.50", cache_write="6.25", reasoning="25.00",
          context_window=500_000, max_output_tokens=64_000, latency=1250,
          quality="0.96", prompt_cache=True, batch=True, vision=True),
    _card(Provider.ANTHROPIC, "claude-sonnet-5", ModelType.MULTIMODAL, inp="3.00", out="15.00",
          cached_in="0.30", cache_write="3.75", context_window=500_000,
          max_output_tokens=64_000, latency=780, quality="0.93",
          prompt_cache=True, batch=True, vision=True),
    _card(Provider.ANTHROPIC, "claude-haiku-4-5", ModelType.CHAT, inp="1.00", out="5.00",
          cached_in="0.10", cache_write="1.25", context_window=200_000,
          max_output_tokens=64_000, latency=380, quality="0.84",
          prompt_cache=True, batch=True, vision=True),
    # ---- Google ----
    _card(Provider.GOOGLE_GEMINI, "gemini-2.5-pro", ModelType.MULTIMODAL, inp="1.25",
          out="10.00", cached_in="0.31", context_window=1_048_576,
          max_output_tokens=65_536, latency=1100, quality="0.93",
          prompt_cache=True, batch=True, vision=True),
    _card(Provider.GOOGLE_GEMINI, "gemini-2.5-flash", ModelType.MULTIMODAL, inp="0.30",
          out="2.50", cached_in="0.075", context_window=1_048_576,
          max_output_tokens=65_536, latency=420, quality="0.85",
          prompt_cache=True, batch=True, vision=True),
    _card(Provider.GOOGLE_GEMINI, "gemini-2.5-flash-lite", ModelType.CHAT, inp="0.10",
          out="0.40", context_window=1_048_576, max_output_tokens=65_536,
          latency=260, quality="0.76", batch=True, vision=True),
    # ---- Azure OpenAI (same list price, different commercial envelope) ----
    _card(Provider.AZURE_OPENAI, "gpt-4.1", ModelType.MULTIMODAL, inp="2.00", out="8.00",
          cached_in="0.50", context_window=1_047_576, max_output_tokens=32_768,
          latency=950, quality="0.92", prompt_cache=True, batch=True, vision=True),
    _card(Provider.AZURE_OPENAI, "gpt-4.1-mini", ModelType.MULTIMODAL, inp="0.40",
          out="1.60", cached_in="0.10", context_window=1_047_576,
          max_output_tokens=32_768, latency=600, quality="0.86",
          prompt_cache=True, batch=True, vision=True),
    # ---- Bedrock ----
    _card(Provider.AWS_BEDROCK, "anthropic.claude-sonnet-5", ModelType.MULTIMODAL,
          inp="3.00", out="15.00", cached_in="0.30", context_window=500_000,
          max_output_tokens=64_000, latency=850, quality="0.93",
          prompt_cache=True, batch=True, vision=True),
    _card(Provider.AWS_BEDROCK, "meta.llama-4-70b", ModelType.CHAT, inp="0.72",
          out="0.72", context_window=128_000, max_output_tokens=8_192,
          latency=500, quality="0.79", batch=True),
    # ---- Cost-optimised / OSS hosts ----
    _card(Provider.MISTRAL, "mistral-large-2", ModelType.CHAT, inp="2.00", out="6.00",
          context_window=128_000, max_output_tokens=8_192, latency=700, quality="0.85"),
    _card(Provider.MISTRAL, "mistral-small-3", ModelType.CHAT, inp="0.20", out="0.60",
          context_window=128_000, max_output_tokens=8_192, latency=320, quality="0.75"),
    _card(Provider.COHERE, "command-a", ModelType.CHAT, inp="2.50", out="10.00",
          context_window=256_000, max_output_tokens=8_192, latency=650, quality="0.84"),
    _card(Provider.COHERE, "embed-v4", ModelType.EMBEDDING, embedding="0.12",
          context_window=128_000, max_output_tokens=0, latency=140,
          quality="0.87", tools=False),
    _card(Provider.DEEPSEEK, "deepseek-v3", ModelType.CHAT, inp="0.27", out="1.10",
          cached_in="0.07", context_window=128_000, max_output_tokens=8_192,
          latency=600, quality="0.83", prompt_cache=True),
    _card(Provider.DEEPSEEK, "deepseek-r1", ModelType.REASONING, inp="0.55", out="2.19",
          reasoning="2.19", context_window=128_000, max_output_tokens=32_768,
          latency=1600, quality="0.88"),
    _card(Provider.GROQ, "llama-4-70b", ModelType.CHAT, inp="0.59", out="0.79",
          context_window=128_000, max_output_tokens=8_192, latency=90, quality="0.79"),
    _card(Provider.GROQ, "llama-4-8b", ModelType.CHAT, inp="0.05", out="0.08",
          context_window=128_000, max_output_tokens=8_192, latency=45, quality="0.66"),
    _card(Provider.TOGETHER, "qwen-3-72b", ModelType.CHAT, inp="0.90", out="0.90",
          context_window=128_000, max_output_tokens=8_192, latency=420, quality="0.81"),
    _card(Provider.FIREWORKS, "llama-4-405b", ModelType.CHAT, inp="3.00", out="3.00",
          context_window=128_000, max_output_tokens=8_192, latency=900, quality="0.87"),
    ...
    _card(Provider.VLLM, "llama-4-70b-local", ModelType.LOCAL, context_window=128_000,
          max_output_tokens=8_192, latency=300, quality="0.79"),
    _card(Provider.OLLAMA, "llama-4-8b-local", ModelType.LOCAL, context_window=128_000,
          max_output_tokens=8_192, latency=250, quality="0.66"),
)
...
class PricingCatalog:
    ...
    def add(self, card: RateCard) -> None:
        ...
        self._by_key[(card.provider, card.model)].sort(
            key=lambda c: c.effective_from, reverse=True
        )

    def resolve(
        self, provider: Provider, model: str, at: datetime | None = None
    ) -> RateCard | None:
